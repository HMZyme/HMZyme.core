...
from hmzyme.utils import is_valid_dir, file_or_folder, parse_result_files
from hmzyme.diagram_cycles import create_input_diagram, create_diagram_figures
...
def search_hmm(input_variable, output_folder, core_number=1):
    ...
    metadata_file = os.path.join(output_folder, 'hmzyme_metadata.json')
